        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PointsSettings_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RoomId = table.Column<int>(type: "int", nullable: false),
                    TotalPriceAtOrderTime = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_CreatedOn",
                table: "Branches",
                column: "CreatedOn");

            migrationBuilder.CreateIndex(
                name: "IX_Branches_LastModifiedOn",
                table: "Branches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Guests_CreatedOn",
                table: "Guests",
                column: "CreatedOn");

            migrationBuilder.CreateIndex(
                name: "IX_Guests_LastModifiedOn",
                table: "Guests",
                column: "LastModifiedOn");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_CreatedOn",
                table: "HelpRequests",
                column: "CreatedOn");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_LastModifiedOn",
                table: "HelpRequests",
                column: "LastModifiedOn");

            migrationBuilder.CreateIndex(
                name: "IX_HelpRequests_RoomId",
                table: "HelpRequests",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_CreatedOn",
                table: "OrderItems",
                column: "CreatedOn");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_LastModifiedOn",
                table: "OrderItems",
                column: "LastModifiedOn");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointsSettings_BranchId",
                table: "PointsSettings",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_PointsSettings_CreatedOn",
                table: "PointsSettings",
                column: "CreatedOn");

            migrationBuilder.CreateIndex(
                name: "IX_PointsSettings_LastModifiedOn",
                table: "PointsSettings",
                column: "LastModifiedOn");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_LastModifiedOn",
                table: "Products",
                column: "LastModifiedOn");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_CreatedOn",
                table: "Rooms",
                column: "CreatedOn");

            migrationBuilder.CreateIndex(
                name: "IX_Rooms_LastModifiedOn",
                table: "Rooms",
                column: "LastModifiedOn");
